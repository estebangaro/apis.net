...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Button runat="server" ID="btn_ObtenJugadores" Text="Obtener Lista Jugadores" OnClick="btn_GetJugadoresAsync_Click"/>
        </div> 
        <div>
        ...
        <div id="maracdoListaJugadores" runat="server"></div>
    </form>
</body>
</html>
